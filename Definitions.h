...
static const uint32_t MMAP_SIZE = 0x481AEFFF-MMAP_OFFSET;
...
////! @brief This enum is used for selecting PWM name.
enum pwmName
{
//  P8_13 = 0,
//  P8_19 = 1,
...
static const std::string pwmNameMap[7] = { "P8_13", "P8_19", "P9_14", "P9_16", "P9_21","P9_22", "P9_42"};;
...
static const float ADC_GAIN = 0.108075652953F;//In mV per count
static const uint32_t ADC_OFFSET = 409U; //In mV per count
static const uint32_t ADC_MAX_GONIO = 3740U;
